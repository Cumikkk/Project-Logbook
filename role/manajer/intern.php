...
if (isset($_POST['aksi']) && $_POST['aksi'] === "tambah") {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        $error = "Anda belum ditugaskan ke divisi manapun!";
    } else {
...
if (isset($_POST['aksi']) && $_POST['aksi'] === "edit") {
    ...
    // Pastikan intern ini milik divisi manajer
    $cek_milik = mysqli_query($conn, "
        SELECT id FROM intern_detail
        WHERE user_id = $id AND divisi_id = $divisi_id AND manajer_id = $manajer_id
    ");
    if (mysqli_num_rows($cek_milik) === 0) {
        $error = "Akses ditolak!";
    } else {
        $cek_email = mysqli_query($conn, "SELECT * FROM users WHERE email='$email' AND id != $id");
        if (mysqli_num_rows($cek_email) > 0) {
            ...
            mysqli_query($conn, "UPDATE intern_detail SET tanggal_mulai='$tanggal_mulai', tanggal_selesai='$tanggal_selesai'
                WHERE user_id=$id");
...
if (isset($_GET['hapus']) && is_numeric($_GET['hapus'])) {
    ...
    if ($intern) {
        ...
        header("Location: " . BASE_URL . "role/manajer/intern.php?hapus=success");
        exit;
    }
}
...
// AMBIL DATA INTERN DI DIVISI INI
$rows = [];
if ($divisi_id) {
        ...
        <div class="d-flex align-items-center">
            <div class="flex-grow-1">
                ...
                <p class="text-white mb-0" style="color: rgba(255,255,255,0.75) !important;">
                    Divisi: <?= htmlspecialchars($nama_divisi) ?>
                </p>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3 bg-light"
                                value="<?= htmlspecialchars($nama_divisi) ?>" readonly>
                        </div>
                        <div class="col-md-6">
...
<script>
    ...
    function bukaModalEdit(id, nama, email, tanggalMulai, tanggalSelesai) {
